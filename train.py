...
parser.add_argument('--train', default='/root/autodl-tmp/DOTA1/train/', dest='train', required=False, help='the path of training dataset')
parser.add_argument('--val', default='/root/autodl-tmp/DOTA1/test/', dest='val', required=False, help='the path of validation dataset')
...
# --config
# examples/example/config_128_192.json
# -n
# baseline_128_v2
